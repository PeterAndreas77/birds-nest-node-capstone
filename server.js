      ...
      //if the username is found
        ...
        items.validatePassword(password, function(err, isValid) {
          ...
          if (err) {
            //display error
            console.log(
              "Could not connect to the DB to validate the password."
            );
          }
...
app.get("/flight-plan/:user", (req, res) => {
  FlightLog.find({ author: req.params.user })
    .where("visited")
    .equals(false)
...
app.put("/flight-plan/update/:id", (req, res) => {
  ...
  FlightLog.findByIdAndUpdate(req.params.id, { $set: newObj }, { new: true })
...
app.delete("/flight-plan/delete/:id", function(req, res) {
  FlightLog.findByIdAndRemove(req.params.id)
...
app.put("/flight-log/create/:id", (req, res) => {
  ...
  FlightLog.findByIdAndUpdate(req.params.id, { $set: newLogObj }, { new: true })
...
app.put("/flight-log/update/:id", (req, res) => {
  ...
  FlightLog.findByIdAndUpdate(req.params.id, { $set: updLogObj }, { new: true })
